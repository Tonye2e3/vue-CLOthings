              ...
              -->
                ...
                -->
                  <button
                    type="button"
                    class="stat-like-btn"
                    :class="{ liked: isPostLiked(featurePost.communityPostId) }"
                    @click="toggleLikePost(featurePost)"
                  >
                    <svg
                      class="icon-inline"
                      viewBox="0 0 24 24"
                      width="14"
                      height="14"
                      :fill="isPostLiked(featurePost.communityPostId) ? 'currentColor' : 'none'"
                      stroke="currentColor"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <div class="post-body">
                  ...
                  -->
                    <button
                      type="button"
                      class="stat-like-btn"
                      :class="{ liked: isPostLiked(post.communityPostId) }"
                    ...
                    >
                      <svg
                        ...
                        width="13"
                        height="13"
                        :fill="isPostLiked(post.communityPostId) ? 'currentColor' : 'none'"
                        stroke="currentColor"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
