        ...
        <div class="reset-card">
            ...
            <template v-else>
                ...
                <div class="form-group">
                    ...
                    <input v-model="newPassword" type="password" placeholder="請輸入新密碼" autocomplete="new-password" />
                </div>
                ...
                <button type="button" class="submit-btn" :disabled="isSubmitting || passwordMismatch"
                    @click="resetPassword">
