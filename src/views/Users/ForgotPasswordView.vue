    ...
    <div class="forgot-card">
      ...
      <template v-else>
        <div class="success-area">
          ...
          <p class="forgot-label">EMAIL SENT</p>
          ...
          <p>
            如果
            <strong>{{ email }}</strong>
            已註冊 CLOthings， 你將會收到密碼重設信件。
          </p>

          <p class="hint">沒收到信件？請檢查垃圾郵件， 或稍後重新嘗試。</p>

          <button type="button" class="submit-btn" @click="router.push('/login')">返回登入</button>

          <button type="button" class="back-btn" @click="isSent = false">重新寄送</button>
        </div>
      </template>
    </div>
  </div>
