...
export const getProductForEdit = (id) =>
  http.get(`/GroupProduct/${id}/edit`).then((res) => res.data)
export const createProduct = (payload) =>
  http.post('/GroupProduct', payload).then((res) => res.data)
...
export const getTiers = (productId) =>
  http.get(`/GroupProduct/${productId}/tiers`).then((res) => res.data)
export const addTier = (productId, payload) =>
  http.post(`/GroupProduct/${productId}/tiers`, payload).then((res) => res.data)
...
// ---- 商品規格管理 ----
export const getSpecifications = (productId) =>
  http.get(`/GroupProduct/${productId}/specifications`).then((res) => res.data)
export const addSpecification = (productId, payload) =>
  http.post(`/GroupProduct/${productId}/specifications`, payload).then((res) => res.data)
...
export const createCategory = (payload) =>
  http.post('/GroupLookup/categories', payload).then((res) => res.data)
...
export const createSupplier = (payload) =>
  http.post('/GroupLookup/suppliers', payload).then((res) => res.data)
...
export const createShipper = (payload) =>
  http.post('/GroupShipper', payload).then((res) => res.data)
...
export const getAllCustomerService = () =>
  http.get('/GroupCustomerService/admin/all').then((res) => res.data)
...
export const updateOrderStatus = (orderId, status) =>
  http.put(`/GroupOrder/${orderId}/status`, { status })
export const assignShipper = (orderId, payload) =>
  http.put(`/GroupOrder/${orderId}/shipper`, payload)
